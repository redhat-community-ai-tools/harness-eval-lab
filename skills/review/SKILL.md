...
**If the user chose file:** write the report as markdown to the path they specified (or suggest `review-report.md` in the current directory). Tell them the file path when done.
