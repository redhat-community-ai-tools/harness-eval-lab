...
from harness_eval_lab.inspection.types import Finding, InspectionResult, Severity
    ...
    run: dict = {
        "tool": {
            "driver": {
                "name": "setup-eval",
                "version": version,
                "informationUri": "https://github.com/redhat-community-ai-tools/harness-eval-lab",
                "rules": rules,
            },
        },
