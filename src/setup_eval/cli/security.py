...
from setup_eval.cli._helpers import emit_output
from setup_eval.core.setup import discover_setup
from setup_eval.inspection.types import AdjudicatedFinding, Finding, Severity
...
def eval_setup_security(
    ...
    from setup_eval.inspection.types import InspectionResult
    ...
    if review:
        ...
        from setup_eval.rubric.dimensions import SECURITY_REVIEW_CATEGORIES
        from setup_eval.rubric.prompts.adjudication import (
            ADJUDICATION_SYSTEM,
            build_adjudication_prompt,
        )
        from setup_eval.rubric.scorer import RubricChecker
        from setup_eval.utils.llm import create_client
        ...
        from setup_eval.rubric.types import RubricResult
    ...
    if fmt == "sarif":
        from setup_eval.output.sarif import format_sarif
